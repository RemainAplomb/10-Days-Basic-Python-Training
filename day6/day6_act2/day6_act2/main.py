...
while continueRunning == True:
    try:
        ...
        insurance = float ( input ( " Enter health insurance amount: " ) )
        ...
        grossSalary = GrossSalary.gross ( numberHours )
        deductions = SalaryDeductions.deductions( grossSalary, loan, insurance )
